...
<html lang="en" class="h-100">
    <head>
        ...
        <title>CMF Radio - Notificaciones</title>
        ...
        <style>
            #intro {
                background-image: url(https://i.ibb.co/GxbBF7Q/img-background.jpg);
                height: 100vh;
            }
          ...
          <div class="row justify-content-center">
            <div class="col-xl-5 col-md-8">
              <form method="post" class="bg-white  rounded-5 shadow-5-strong p-5">
                ...
                <div align="right">
                    <button type="submit" name="submit" class="btn btn-primary btn-lg btn-rounded">Enviar Notificacion</button>
                </div>
